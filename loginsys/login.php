...
// jab confirm ho jaaye ki USER HAS LOGGED IN - then START THE SESSION.
...
// password_verify() --> converts first argument(pass entered by user) into hash & checks it with value in table(hash value)
